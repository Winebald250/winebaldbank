...
<nav>
    <div class="logo">
        <img src="images/winebald_symbol.jpg" width="45" alt="" class="logo-img">
        Winebald Bank
    </div>
    <style>
        .logo-img {
                ...
                <div class="bg-white rounded-lg shadow-sm p-5">
                    ...
                    <div class="tab-content">
                        <div id="nav-tab-card" class="tab-pane fade show active">
                            ...
                            if (isset($_POST['get'])) {
                                $accountNo = $_POST['otherNo'];
                                $array2 = $con->query("SELECT * FROM otheraccounts WHERE accountno = '$accountNo'");
                                $array3 = $con->query("SELECT * FROM userAccounts WHERE accountno = '$accountNo'");
                                ...
                                if ($array2->num_rows > 0) {
                                    ...
                                    echo "<div class='row'>
                                        ...
                                        <div class='col'>
                                            Bank Balance
                                            <input type='text' class='form-control my-1' value='RWF " . (isset($row2['deposit']) ? $row2['deposit'] : '0') . "' readonly required>
                                            <form method='POST'>
                                                ...
                                                <input type='number' class='form-control my-1' name='amount' placeholder='Write Amount for withdraw' min='3000' max='" . (isset($row2['deposit']) ? $row2['deposit'] : '0') . "' required>
                                                <button type='submit' name='withdrawOther' class='btn btn-primary btn-block btn-sm my-1'>Withdraw</button>
                                            </form>
                                            <form method='POST'>
                                                <input type='hidden' value='{$row2['accountno']}' name='accountNo' class='form-control' required>
                                                <input type='hidden' value='{$row2['id']}' name='userid' class='form-control' required>
                                    ...
                                    echo "<div class='row'>
                                        ...
                                        <div class='col'>
                                            ...
                                            <form method='POST'>
                                                ...
                                                <input type='number' class='form-control my-1' name='checkno' placeholder='Write Check Number' required>
                                                <input type='number' class='form-control my-1' name='amount' placeholder='Write Amount for withdraw' min='3000' max='" . (isset($row2['deposit']) ? $row2['deposit'] : '0') . "' required>
                                                <button type='submit' name='withdraw' class='btn btn-primary btn-block btn-sm my-1'>Withdraw</button>
                                            </form>
                                            <form method='POST'>
                                                <input type='hidden' value='{$row2['accountno']}' name='accountNo' class='form-control' required>
                                                <input type='hidden' value='{$row2['id']}' name='userid' class='form-control' required>
