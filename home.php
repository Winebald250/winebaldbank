      ...
      <section class="light">
		...
		<article class="postcard light blue">
			<a class="postcard__img_link" href="#">
				<img class="postcard__img" src="images/winebald_symbol.jpg" alt="Image Title" />
			</a>
			<div class="postcard__text t-dark">
				<h1 class="postcard__title blue"><a href="#">Welcome to Winebald Bank</a></h1>
				
				<div class="postcard__bar"></div>
				<div class="postcard__preview-txt"><b>Winebald Bank</b> is the biggest commercial bank in Rwanda. It is a Private sector bank and has its headquarters in Kigali, Rwanda. It has a total of 3 regional hubs and 5 zonal offices located at almost every city throughout Rwanda.</div>
