...
<meta charset="utf-8">
      <title>Winebald Bank</title>
    <link href="assets/images/winebald_symbol.jpg" rel="icon">
   <link href="assets/images/winebald_symbol.jpg" rel="apple-touch-icon">
                    ...
                    <div class="card-body">  
                        <form id="needs-validation" method="POST" >  
                            <div class="row">  
                                ...
                                <div class="col-sm-6 col-md-6 col-xs-12">  
                                    <div class="form-group">  
                                        <label>Richard card </label>  
                                        <input type="tel" id="aadhaar" name="aadhaar" pattern="^\d{12}$"  placeholder="Enter Your Richard card "class="form-control"  required />  
                                        <div class="invalid-feedback">  
                                        Please Enter Your Richard card
                                        </div>
